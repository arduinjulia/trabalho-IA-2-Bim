...
O dataset IMDb contém 50.000 avaliações de filmes classificadas em dois sentimentos: positivo e negativo. A base possui duas colunas (review e sentiment) e não apresenta valores nulos. Os dados estão balanceados, contendo aproximadamente 25.000 exemplos de cada classe.
